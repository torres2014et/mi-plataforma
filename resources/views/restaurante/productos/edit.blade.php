<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <h2 class="font-black text-white text-xl">Editar producto</h2>
        </div>
    </x-slot>
    ...
    <div class="py-8">
        <div class="max-w-xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="form-section">
                <form action="{{ route('restaurante.productos.update', $producto) }}" method="POST"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="precio" value="{{ old('precio', $producto->precio) }}" required min="0" step="100"
